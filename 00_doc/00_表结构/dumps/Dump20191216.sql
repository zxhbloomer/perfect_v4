...
INSERT INTO `m_address` VALUES (2,'123456','刘德华','021-123456',0,'0',31,3101,310117,'上海市 市辖区 松江区西路',NULL,NULL,0,1,1,'2019-11-07 08:38:33',1,'2019-11-07 08:38:33',0);
...
CREATE TABLE `m_company` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='公司主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_company` VALUES (1,'1','测试企业1','测试企业1',NULL,'1',1.0000,'3','2019-11-05','2019-11-27',0,'',0,1,1,'2019-11-07 15:54:02',29,'2019-12-02 14:33:31',1),(2,'0','测试企业0','测试企业0',NULL,'测试企业0',0.0000,'1','2018-11-01','9999-01-01',1,'',0,1,1,'2019-11-08 11:36:29',29,'2019-12-02 16:47:24',4),(3,'2','测试企业2','测试企业2',NULL,'2',2.0000,'3','2019-11-05','2019-11-27',0,'',0,1,29,'2019-12-02 16:33:08',29,'2019-12-02 16:33:08',0);
...
CREATE TABLE `m_dept` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部门主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_dept` VALUES (1,'xx1','部门1','www',NULL,NULL,NULL,NULL,'',0,1,29,'2019-11-25 11:07:20',29,'2019-11-25 11:07:20',0);
...
CREATE TABLE `m_group` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='集团主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_group` VALUES (4,'1','23','1','',0,1,1,'2019-10-30 14:14:51',29,'2019-12-02 16:48:26',6),(5,'2','1','2','',0,1,1,'2019-10-30 14:17:08',1,'2019-10-30 14:32:59',1),(6,'zjjt01','中建集团','中建集团','',0,1,29,'2019-11-18 10:07:45',29,'2019-11-18 10:07:45',0),(7,'zjjt01-01','中建子集团','中建子集团','',0,1,29,'2019-12-02 14:17:19',29,'2019-12-02 14:17:19',0),(8,'zjjt01-02','中建子集团02','中建子集团02','',0,1,29,'2019-12-02 16:49:24',29,'2019-12-02 16:49:24',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='组织主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_org` VALUES (1,NULL,1,1,'s_tenant','10','0001',4,29,'2019-11-18 11:27:17',29,'2019-12-02 14:24:51',15),(23,1,1,6,'m_group','20','00010004',2,29,'2019-12-02 14:24:51',29,'2019-12-03 11:17:12',2),(24,23,1,7,'m_group','20','000100040001',1,29,'2019-12-02 14:24:59',29,'2019-12-02 14:33:35',1),(26,23,1,1,'m_dept','40','000100040002',0,29,'2019-12-03 11:17:12',29,'2019-12-03 11:17:28',1);
...
CREATE TABLE `m_position` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='岗位主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_position` VALUES (1,'xx','xx','xx','xxxx',0,NULL,1,'2019-11-12 15:04:50',1,'2019-11-12 15:07:05',3);
...
INSERT INTO `m_staff` VALUES (22,'负责人',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,24,0,1,1,'2019-11-12 11:19:48',1,'2019-11-12 11:19:48',1),(23,'副负责人',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,25,0,1,1,'2019-11-12 11:21:20',1,'2019-11-12 11:21:20',1),(24,'领导',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,26,0,1,1,'2019-11-12 11:22:34',1,'2019-11-12 11:22:34',1),(25,'测试登录',NULL,NULL,NULL,'1',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','啊',NULL,29,0,1,1,'2019-11-12 11:22:34',29,'2019-11-19 11:27:52',4),(26,'领导1想',NULL,NULL,NULL,'1',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,26,0,1,29,'2019-11-12 11:22:34',29,'2019-11-19 11:43:42',1),(28,'123',NULL,'123',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,13,NULL,'2019-12-16 14:25:08',NULL,'2019-12-16 14:25:08',1);
...
CREATE TABLE `m_user` (
  ...
  `login_author_way` varchar(1) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '传统认证方式=0,智能钥匙认证=1,动态密码锁=2,指纹认证方式=3',
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_code` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '编码类型',
  `rule` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '编码规则',
  `code` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '当前编码',
  `auto_create` int(11) DEFAULT NULL COMMENT '代码增加序号',
  `prefex` varchar(5) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '前缀',
  `c_id` bigint(20) DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  `u_id` bigint(20) DEFAULT NULL,
  `u_time` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='编码控制';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_code` VALUES (2,'s_tenant','10','ZH20191216NX001',1,'ZH',29,'2019-12-13 15:11:44',29,'2019-12-13 15:33:12',5),(4,'s_menu','10','M20191216KZ007',7,'M',29,'2019-12-16 15:48:54',29,'2019-12-16 15:48:54',6);
...
CREATE TABLE `s_dict_data` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_dict_data` VALUES (1,NULL,1,0,'未删除','0','',0,1,'2019-09-03 01:56:58',1,'2019-09-26 07:51:27',60),(2,NULL,1,1,'已删除','1','1',0,1,'2019-09-02 18:13:52',1,'2019-09-26 07:51:27',61),(5,NULL,1,2,'全部','null','',0,1,'2019-09-03 07:53:30',1,'2019-09-26 07:51:28',60),(6,NULL,2,0,'目录','c','',0,1,'2019-10-31 11:31:13',1,'2019-10-31 11:31:13',0),(7,NULL,2,1,'菜单','m','',0,1,'2019-10-31 11:31:38',1,'2019-10-31 11:31:38',0),(8,NULL,2,2,'页面','p','',0,1,'2019-10-31 11:31:50',1,'2019-10-31 11:31:50',0),(9,NULL,3,0,'显示','0','',0,1,'2019-11-01 11:45:56',1,'2019-11-04 09:25:11',2),(10,NULL,3,1,'隐藏','1','',0,1,'2019-11-01 11:46:14',1,'2019-11-04 09:25:11',2),(11,NULL,3,2,'全部','null','',0,1,'2019-11-01 11:46:30',1,'2019-11-04 09:25:11',2),(12,NULL,4,0,'国有全资','1','',0,1,'2019-11-05 11:00:28',1,'2019-11-05 11:00:28',0),(13,NULL,4,1,'集体全资','2','',0,1,'2019-11-05 11:00:39',1,'2019-11-05 11:00:39',0),(14,NULL,4,2,'股份合作','3','',0,1,'2019-11-05 11:00:47',1,'2019-11-05 11:00:47',0),(15,NULL,4,3,'联营','4','',0,1,'2019-11-05 11:00:56',1,'2019-11-05 11:00:56',0),(16,NULL,4,4,'国有联营','5','',0,1,'2019-11-05 11:01:02',1,'2019-11-05 11:01:02',0),(17,NULL,4,5,'集体联营','6','',0,1,'2019-11-05 11:01:10',1,'2019-11-05 11:01:10',0),(18,NULL,4,6,'国有与集体联营','7','',0,1,'2019-11-05 11:01:17',1,'2019-11-05 11:01:17',0),(19,NULL,4,7,'其它联营','8','',0,1,'2019-11-05 11:01:25',1,'2019-11-05 11:01:25',0),(20,NULL,4,8,'有限责任（公司）','9','',0,1,'2019-11-05 11:01:34',1,'2019-11-05 11:01:34',0),(21,NULL,4,9,'国有独资（公司）','10','',0,1,'2019-11-05 11:01:44',1,'2019-11-05 11:01:44',0),(22,NULL,4,10,'其它有限责任（公司）','11','',0,1,'2019-11-05 11:01:52',1,'2019-11-05 11:01:52',0),(23,NULL,4,11,'股份有限（公司）','12','',0,1,'2019-11-05 11:02:01',1,'2019-11-05 11:02:01',0),(24,NULL,4,12,'私有','13','',0,1,'2019-11-05 11:02:09',1,'2019-11-05 11:02:09',0),(25,NULL,4,13,'私有独资','14','',0,1,'2019-11-05 11:02:16',1,'2019-11-05 11:02:16',0),(26,NULL,4,14,'私有合伙','15','',0,1,'2019-11-05 11:02:23',1,'2019-11-05 11:02:23',0),(27,NULL,4,15,'私营有限责任（公司）','16','',0,1,'2019-11-05 11:02:33',1,'2019-11-05 11:02:33',0),(28,NULL,4,16,'个体经营','17','',0,1,'2019-11-05 11:02:40',1,'2019-11-05 11:02:40',0),(29,NULL,4,17,'私营股份有限（公司）','18','',0,1,'2019-11-05 11:02:49',1,'2019-11-05 11:02:49',0),(32,NULL,4,18,'内地与港、澳、台合作','19','',0,1,'2019-11-05 11:04:30',1,'2019-11-05 11:04:30',0),(33,NULL,4,19,'内地与港、澳、台合资','20','',0,1,'2019-11-05 11:04:38',1,'2019-11-05 11:04:38',0),(34,NULL,4,20,'港、澳、台投资','21','',0,1,'2019-11-05 11:04:46',1,'2019-11-05 11:04:46',0),(35,NULL,4,21,'港、澳、台独资','22','',0,1,'2019-11-05 11:04:55',1,'2019-11-05 11:04:55',0),(36,NULL,4,22,'港、澳、台投资股份有限（公司）','23','',0,1,'2019-11-05 11:05:03',1,'2019-11-05 11:05:03',0),(37,NULL,4,23,'其他港、澳、台投资','24','',0,1,'2019-11-05 11:05:12',1,'2019-11-05 11:05:12',0),(38,NULL,4,24,'外资','25','',0,1,'2019-11-05 11:05:21',1,'2019-11-05 11:05:21',0),(39,NULL,4,25,'国外投资股份有限（公司）','26','',0,1,'2019-11-05 11:05:28',1,'2019-11-05 11:05:28',0),(40,NULL,4,26,'其他国外投资','27','',0,1,'2019-11-05 11:05:38',1,'2019-11-05 11:05:38',0),(41,NULL,4,27,'其他','28','',0,1,'2019-11-05 11:05:45',1,'2019-11-05 11:05:45',0),(42,NULL,5,0,'表：地址簿','m_company','',0,1,'2019-11-05 11:41:06',1,'2019-11-05 11:41:06',0),(43,NULL,6,0,'公司','0','',0,1,'2019-11-06 11:48:53',1,'2019-11-06 11:48:53',0),(44,NULL,6,1,'家庭','1','',0,1,'2019-11-06 11:49:01',1,'2019-11-06 11:49:01',0),(45,NULL,7,0,'男','1','男=1,女=2',0,1,'2019-11-08 10:09:29',1,'2019-11-08 10:09:29',0),(46,NULL,7,1,'女','2','男=1,女=2',0,1,'2019-11-08 10:10:03',1,'2019-11-08 10:10:03',0),(47,NULL,8,0,'在职','1','',0,1,'2019-11-08 10:11:03',1,'2019-11-08 10:11:03',0),(48,NULL,8,1,'不在职','0','',0,1,'2019-11-08 10:11:17',1,'2019-11-08 10:11:17',0),(49,NULL,8,2,'离职','2','',0,1,'2019-11-08 10:11:26',1,'2019-11-08 10:11:26',0),(50,NULL,8,3,'离退休','3','',0,1,'2019-11-08 10:11:34',1,'2019-11-08 10:11:34',0),(51,NULL,8,4,'返聘','4','',0,1,'2019-11-08 10:11:41',1,'2019-11-08 10:11:41',0),(52,NULL,9,0,'博士','0','',0,1,'2019-11-08 10:21:46',1,'2019-11-08 10:21:46',0),(53,NULL,9,1,'硕士','1','',0,1,'2019-11-08 10:21:55',1,'2019-11-08 10:21:55',0),(54,NULL,9,2,'本科','2','',0,1,'2019-11-08 10:22:04',1,'2019-11-08 10:22:04',0),(55,NULL,9,3,'大专','3','',0,1,'2019-11-08 10:22:11',1,'2019-11-08 10:22:11',0),(56,NULL,9,4,'高中/中技/中专','4','',0,1,'2019-11-08 10:22:22',1,'2019-11-08 10:22:22',0),(57,NULL,9,5,'初中及以下','5','',0,1,'2019-11-08 10:22:29',1,'2019-11-08 10:22:29',0),(58,NULL,9,6,'其他','6','',0,1,'2019-11-08 10:22:37',1,'2019-11-08 10:22:37',0),(59,NULL,10,0,'未婚','0','',0,1,'2019-11-08 11:52:25',1,'2019-11-08 11:52:25',0),(60,NULL,10,1,'已婚','1','',0,1,'2019-11-08 11:52:32',1,'2019-11-08 11:52:32',0),(61,NULL,11,0,'系统用户','10','',0,1,'2019-11-08 16:52:04',1,'2019-11-08 16:52:04',0),(62,NULL,11,1,'职员','20','',0,1,'2019-11-08 16:52:19',1,'2019-11-08 16:52:19',0),(63,NULL,11,2,'客户','30','',0,1,'2019-11-08 16:52:28',1,'2019-11-08 16:52:28',0),(64,NULL,11,3,'供应商','40','',0,1,'2019-11-08 16:52:37',1,'2019-11-08 16:52:37',0),(65,NULL,11,4,'其他','50','',0,1,'2019-11-08 16:52:52',1,'2019-11-08 16:52:52',0),(66,NULL,11,5,'认证管理员','60','',0,1,'2019-11-08 16:53:13',1,'2019-11-08 16:53:13',0),(67,NULL,12,0,'租户','10','',0,29,'2019-11-18 10:05:44',29,'2019-11-18 10:05:44',0),(68,NULL,12,1,'集团','20','',0,29,'2019-11-18 10:06:02',29,'2019-11-18 10:06:02',0),(69,NULL,12,2,'企业','30','',0,29,'2019-11-18 10:06:10',29,'2019-11-18 10:06:10',0),(70,NULL,12,3,'部门','40','',0,29,'2019-11-18 10:06:19',29,'2019-11-18 10:06:19',0),(71,NULL,12,4,'岗位','50','',0,29,'2019-11-18 10:06:28',29,'2019-11-18 10:06:28',0),(72,NULL,12,5,'员工','60','',0,29,'2019-11-18 10:06:37',29,'2019-11-18 10:06:37',0),(73,NULL,13,0,'手机号码','10','',0,29,'2019-12-03 11:30:56',29,'2019-12-03 11:30:56',0),(74,NULL,13,1,'邮箱','20','',0,29,'2019-12-03 11:31:16',29,'2019-12-03 11:31:16',0),(77,NULL,14,0,'YYYYMMDD??999','10','',0,29,'2019-12-12 15:03:52',29,'2019-12-13 15:13:42',3),(78,NULL,15,0,'租户编码','s_tenant','',0,29,'2019-12-13 14:56:29',29,'2019-12-13 14:57:23',1),(80,NULL,15,1,'菜单组编号','s_menu','',0,29,'2019-12-16 15:46:14',29,'2019-12-16 15:46:14',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='字典类型表、字典主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_dict_type` VALUES (1,'删除类型','sys_delete_type','删除类型',0,1,'2019-09-11 01:12:39',1,'2019-09-11 09:12:58',1),(2,'模块类型','sys_module_type','m目录 c菜单 p页面',0,1,'2019-10-31 11:30:47',1,'2019-11-06 11:14:42',1),(3,'隐藏显示类型','sys_visible_type','隐藏显示类型： 0：显示 1：隐藏 null:全部',0,1,'2019-11-01 11:33:09',1,'2019-11-01 11:33:09',0),(4,'企业类型','sys_company_type','企业类型',0,1,'2019-11-05 10:57:51',1,'2019-11-05 10:58:00',1),(5,'关联表类型','sys_serial_type','关联表类型：关联表名',0,1,'2019-11-05 11:40:08',1,'2019-11-07 13:14:43',2),(6,'地址簿标签','sys_address_tag_type','地址簿标签：公司、家庭',0,1,'2019-11-06 11:14:20',1,'2019-11-07 13:14:18',1),(7,'性别类型','sys_sex_type','性别类型：男=1,女=2',0,1,'2019-11-08 10:08:40',1,'2019-11-08 10:09:37',1),(8,'在职状态','usr_service_type','是否在职：在职=1,不在职=0,离职=2,离退休=3,返聘=4',0,1,'2019-11-08 10:10:36',1,'2019-11-08 10:10:36',0),(9,'学历情况','usr_degree_type','学历情况',0,1,'2019-11-08 10:20:46',1,'2019-11-08 10:20:53',1),(10,'婚否','usr_wed_type','婚否：0：未婚；1：已婚',0,1,'2019-11-08 11:52:04',1,'2019-11-08 11:52:04',0),(11,'登录用户类型','usr_login_type','登录用户类型',0,1,'2019-11-08 16:51:29',1,'2019-11-08 16:51:29',0),(12,'组织机构类型','org_setting_type','',0,29,'2019-11-18 10:05:11',29,'2019-11-18 10:05:11',0),(13,'登录模式','sys_login_type','登录模式：（10：手机号码；20：邮箱）',0,29,'2019-12-03 11:30:31',29,'2019-12-03 11:30:31',0),(14,'自动编号规则','sys_coderule_type','YYYYMMDD??999：ZH20191212XA001',0,29,'2019-12-12 14:18:35',29,'2019-12-13 14:56:54',3),(15,'自动编号设置','sys_code_type','',0,29,'2019-12-13 14:49:34',29,'2019-12-13 14:49:34',0);
...
CREATE TABLE `s_log` (
  ...
  `c_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=634 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_log` VALUES (221,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"493d64c2-3b91-4472-a7e8-a7a01560f2a0\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-13 16:48:30'),(222,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-13 16:48:34'),(223,NULL,'根据查询条件，获取租户信息',5,'com.perfect.manager.controller.sys.config.tenant.TenantController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/cascader/list','172.21.11.100','2019-12-13 16:48:34'),(224,NULL,'根据查询条件，获取租户信息',17,'com.perfect.manager.controller.sys.config.tenant.TenantController','list','POST','[{\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/tenant/list','172.21.11.100','2019-12-13 16:48:34'),(225,NULL,'根据查询条件，获取员工主表信息',43,'com.perfect.manager.controller.master.user.MasterStaffController','list','POST','[{\"is_del\":false,\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"tenant_id\":1,\"user\":{}}]','http://localhost:19528/perfect-manager/api/v1/staff/list','172.21.11.100','2019-12-13 16:49:30'),(226,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"493d64c2-3b91-4472-a7e8-a7a01560f2a0\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-13 16:55:19'),(227,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"493d64c2-3b91-4472-a7e8-a7a01560f2a0\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-13 17:02:21'),(228,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"493d64c2-3b91-4472-a7e8-a7a01560f2a0\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-13 17:02:43'),(229,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-13 17:04:58'),(230,NULL,'注册根据手机号码，租户名称，管理员，密码，生成注册信息',58071,'com.perfect.manager.controller.sys.platform.PlatformSignUpController','signUp','POST','[{\"admin\":\"123\",\"encodePassword\":\"$2a$10$UApWpqnRwDxB2jemQWDA.ezknGX4SoJfzwfIKXms87tv.97OUa52m\",\"mobile\":\"13611806866\",\"password\":\"123456\",\"tenant\":\"测试\"}]','http://localhost:19528/perfect-manager/api/v1/signup/mobile','172.21.11.100','2019-12-16 13:26:50'),(231,NULL,'注册根据手机号码，租户名称，管理员，密码，生成注册信息',98854,'com.perfect.manager.controller.sys.platform.PlatformSignUpController','signUp','POST','[{\"admin\":\"123\",\"encodePassword\":\"$2a$10$gaatWx6cHePBO3Gxrxt2PuRl9G5f6px09Fe9F8Ce773VL2rLH8ldW\",\"mobile\":\"13611806866\",\"password\":\"123456\",\"tenant\":\"测试\",\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/signup/mobile','172.21.11.100','2019-12-16 14:25:08'),(232,NULL,'获取用户信息',19,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"55db1f15-ebe1-4b06-9d3d-62bc2abc71a1\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:25:47'),(233,NULL,'根据查询条件，获取租户信息',49,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-16 14:25:52'),(234,NULL,'根据查询条件，获取租户信息',8,'com.perfect.manager.controller.sys.config.tenant.TenantController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/cascader/list','172.21.11.100','2019-12-16 14:25:52'),(235,NULL,'根据查询条件，获取租户信息',148,'com.perfect.manager.controller.sys.config.tenant.TenantController','list','POST','[{\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/tenant/list','172.21.11.100','2019-12-16 14:25:52'),(236,NULL,'根据查询条件，获取租户信息',93,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 14:29:15'),(237,NULL,'根据查询条件，获取组织架构主表信息',87,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":1}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 14:29:15'),(238,NULL,'根据查询条件，获取组织架构主表信息',7,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"code\":\"0001\",\"dbversion\":15,\"id\":1,\"tenant_id\":1,\"type\":\"10\",\"type_text\":\"租户\",\"u_time\":\"2019-12-02T14:24:51\"}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 14:29:15'),(239,NULL,'根据查询条件，获取租户信息',13,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-16 14:30:16'),(240,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"55db1f15-ebe1-4b06-9d3d-62bc2abc71a1\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:30:19'),(241,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 14:30:20'),(242,NULL,'根据查询条件，获取组织架构主表信息',8,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"code\":\"0001\",\"dbversion\":15,\"id\":1,\"tenant_id\":1,\"type\":\"10\",\"type_text\":\"租户\",\"u_time\":\"2019-12-02T14:24:51\"}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 14:30:20'),(243,NULL,'根据查询条件，获取组织架构主表信息',10,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":1}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 14:30:20'),(244,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-16 14:30:32'),(245,NULL,'根据查询条件，获取租户信息',8,'com.perfect.manager.controller.sys.config.tenant.TenantController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/cascader/list','172.21.11.100','2019-12-16 14:30:32'),(246,NULL,'根据查询条件，获取租户信息',17,'com.perfect.manager.controller.sys.config.tenant.TenantController','list','POST','[{\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/tenant/list','172.21.11.100','2019-12-16 14:30:32'),(247,NULL,'根据查询条件，获取租户信息',7,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-16 14:30:45'),(248,NULL,'登出',1,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:32:09'),(249,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"55db1f15-ebe1-4b06-9d3d-62bc2abc71a1\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:32:17'),(250,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"55db1f15-ebe1-4b06-9d3d-62bc2abc71a1\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:32:23'),(251,NULL,'根据查询条件，获取租户信息',8,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-16 14:32:24'),(252,NULL,'根据查询条件，获取租户信息',20,'com.perfect.manager.controller.sys.config.tenant.TenantController','list','POST','[{\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/tenant/list','172.21.11.100','2019-12-16 14:32:24'),(253,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.sys.config.tenant.TenantController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/cascader/list','172.21.11.100','2019-12-16 14:32:24'),(254,NULL,'根据查询条件，获取租户信息',10,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-16 14:32:34'),(255,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.sys.config.tenant.TenantController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/cascader/list','172.21.11.100','2019-12-16 14:32:34'),(256,NULL,'根据查询条件，获取租户信息',14,'com.perfect.manager.controller.sys.config.tenant.TenantController','list','POST','[{\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/tenant/list','172.21.11.100','2019-12-16 14:32:34'),(257,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:32:36'),(258,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"739a3f3b-d106-47f7-b78c-21ce769cf5e8\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:32:40'),(259,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"739a3f3b-d106-47f7-b78c-21ce769cf5e8\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:33:06'),(260,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.sys.config.tenant.TenantController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/tree/list','172.21.11.100','2019-12-16 14:33:06'),(261,NULL,'根据查询条件，获取租户信息',15,'com.perfect.manager.controller.sys.config.tenant.TenantController','list','POST','[{\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/tenant/list','172.21.11.100','2019-12-16 14:33:06'),(262,NULL,'根据查询条件，获取租户信息',7,'com.perfect.manager.controller.sys.config.tenant.TenantController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/tenant/cascader/list','172.21.11.100','2019-12-16 14:33:07'),(263,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:33:09'),(264,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"4dbc0474-7bab-46f9-970a-e29e067b9b00\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:33:15'),(265,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"4dbc0474-7bab-46f9-970a-e29e067b9b00\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:33:26'),(266,NULL,'登出',1,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:33:30'),(267,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"f2ff19b4-6dd8-4a14-9749-3b4696dbde8e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:33:35'),(268,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"f2ff19b4-6dd8-4a14-9749-3b4696dbde8e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:34:35'),(269,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"f2ff19b4-6dd8-4a14-9749-3b4696dbde8e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:34:37'),(270,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:34:43'),(271,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"a59feef1-4059-4cf0-9aaa-ce56ab48dcfe\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:34:47'),(272,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:35:01'),(273,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"313bfe2d-e411-4bd3-a986-45078a0e7c76\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:35:04'),(274,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"313bfe2d-e411-4bd3-a986-45078a0e7c76\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:35:44'),(275,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:36:00'),(276,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"25fd3e2a-c638-4d85-9b86-4135353a58e5\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:36:03'),(277,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"25fd3e2a-c638-4d85-9b86-4135353a58e5\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:38:51'),(278,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:40:14'),(279,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"bfeb99c7-bd54-4bc0-8bad-824aa53a6c8f\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:40:20'),(280,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:40:24'),(281,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"51ecc225-60e8-43ca-b758-f503fcc81975\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:40:36'),(282,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:40:43'),(283,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"51113241-bac4-496b-8292-ef39713b6111\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:40:48'),(284,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"51113241-bac4-496b-8292-ef39713b6111\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:41:33'),(285,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"51113241-bac4-496b-8292-ef39713b6111\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:43:22'),(286,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:43:26'),(287,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"ce7225b8-bea8-42a4-861d-8b78b28b957b\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:43:30'),(288,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:56:11'),(289,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"e3932087-ee37-4b7e-8821-cac3f3a3f64c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:56:15'),(290,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:56:18'),(291,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"aa3291c1-4242-49b4-946e-2c902f3dc7ed\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:56:23'),(292,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 14:56:26'),(293,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"c231f008-0205-4ad1-ac20-c394ef0a0360\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 14:56:33'),(294,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"c231f008-0205-4ad1-ac20-c394ef0a0360\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:10:31'),(295,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"c231f008-0205-4ad1-ac20-c394ef0a0360\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:13:21'),(296,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"c231f008-0205-4ad1-ac20-c394ef0a0360\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:13:23'),(297,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"c231f008-0205-4ad1-ac20-c394ef0a0360\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:16:11'),(298,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:16:34'),(299,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"5173f797-8f62-4706-b301-1106ce61512b\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:16:37'),(300,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"6b8747e7-ee0b-483d-9c33-bc9603097966\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:16:55'),(301,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:17:00'),(302,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"ef9787c2-0c38-426c-a9c0-e63c26fc699f\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:17:03'),(303,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"ef9787c2-0c38-426c-a9c0-e63c26fc699f\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:17:25'),(304,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:17:32'),(305,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"c64bfa8c-fbf2-4ce7-89e6-ea1308d63188\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:17:36'),(306,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:17:41'),(307,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"f600fefb-68b1-44d4-b8bb-4528126993d3\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:17:45'),(308,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"f600fefb-68b1-44d4-b8bb-4528126993d3\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:18:01'),(309,NULL,'根据查询条件，获取租户信息',13,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:18:25'),(310,NULL,'根据查询条件，获取组织架构主表信息',13,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":1}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:18:25'),(311,NULL,'根据查询条件，获取组织架构主表信息',7,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"code\":\"0001\",\"dbversion\":15,\"id\":1,\"tenant_id\":1,\"type\":\"10\",\"type_text\":\"租户\",\"u_time\":\"2019-12-02T14:24:51\"}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:18:25'),(312,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:18:39'),(313,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"462da0ab-1694-4eeb-b05f-10491dbbe44e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:18:45'),(314,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"462da0ab-1694-4eeb-b05f-10491dbbe44e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:18:59'),(315,NULL,'根据查询条件，获取租户信息',7,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:19:00'),(316,NULL,'根据查询条件，获取组织架构主表信息',5,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:19:00'),(317,NULL,'根据查询条件，获取系统参数信息',49,'com.perfect.manager.controller.sys.platform.syscode.PlatformCodeController','list','POST','[{\"code\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/code/list','172.21.11.100','2019-12-16 15:19:06'),(318,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:19:10'),(319,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"84203944-ec6c-45c3-a718-54cc7ed16772\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:19:16'),(320,NULL,'根据查询条件，获取系统参数信息',12,'com.perfect.manager.controller.sys.platform.syscode.PlatformCodeController','list','POST','[{\"code\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/code/list','172.21.11.100','2019-12-16 15:19:17'),(321,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:19:31'),(322,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"e50b3e28-44d3-4807-a7d9-4747d280f271\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:19:38'),(323,NULL,'根据查询条件，获取系统参数信息',10,'com.perfect.manager.controller.sys.platform.syscode.PlatformCodeController','list','POST','[{\"code\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/code/list','172.21.11.100','2019-12-16 15:19:38'),(324,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"e50b3e28-44d3-4807-a7d9-4747d280f271\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:19:46'),(325,NULL,'根据查询条件，获取租户信息',4,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:19:47'),(326,NULL,'根据查询条件，获取组织架构主表信息',5,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:19:47'),(327,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:19:57'),(328,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"50549d53-2aeb-4091-8590-85bdc57d82a3\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:20:01'),(329,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:20:13'),(330,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"55ea0bf2-26d3-44b6-8cfb-63f30c0b74fa\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:20:24'),(331,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"55ea0bf2-26d3-44b6-8cfb-63f30c0b74fa\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:20:49'),(332,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:20:49'),(333,NULL,'根据查询条件，获取组织架构主表信息',4,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:20:49'),(334,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"55ea0bf2-26d3-44b6-8cfb-63f30c0b74fa\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:21:02'),(335,NULL,'根据查询条件，获取租户信息',4,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:21:02'),(336,NULL,'根据查询条件，获取组织架构主表信息',4,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:21:02'),(337,NULL,'登出',1,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:21:05'),(338,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"28536c03-ebef-4d3c-bf85-41dee3ae58bc\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:21:09'),(339,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:21:15'),(340,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:21:28'),(341,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:21:32'),(342,NULL,'根据查询条件，获取租户信息',4,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:21:33'),(343,NULL,'根据查询条件，获取组织架构主表信息',4,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:21:33'),(344,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:22:15'),(345,NULL,'根据查询条件，获取租户信息',6,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:22:15'),(346,NULL,'根据查询条件，获取组织架构主表信息',10,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:22:15'),(347,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:22:26'),(348,NULL,'根据查询条件，获取租户信息',5,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 15:22:27'),(349,NULL,'根据查询条件，获取组织架构主表信息',7,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":13}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 15:22:27'),(350,NULL,'根据查询条件，获取菜单主表信息',105,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:22:46'),(351,NULL,'根据查询条件，获取资源表信息',151,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 15:23:01'),(352,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:23:10'),(353,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:25:07'),(354,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:25:07'),(355,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:27:02'),(356,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:27:05'),(357,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:27:07'),(358,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:27:37'),(359,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:27:40'),(360,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:27:44'),(361,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:28:18'),(362,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:28:21'),(363,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:28:21'),(364,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:28:36'),(365,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:28:38'),(366,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:28:38'),(367,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:28:55'),(368,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:28:56'),(369,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:29:09'),(370,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:29:09'),(371,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:29:26'),(372,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:30:23'),(373,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:30:27'),(374,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:30:28'),(375,NULL,'根据查询条件，获取菜单主表信息',3,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:30:43'),(376,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:30:44'),(377,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:30:46'),(378,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:30:47'),(379,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:30:59'),(380,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:31:00'),(381,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:31:18'),(382,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:31:19'),(383,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:31:20'),(384,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:31:35'),(385,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:31:46'),(386,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:31:59'),(387,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:32:02'),(388,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:32:03'),(389,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:32:17'),(390,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"673b0be1-55a9-4054-bfc5-b70e3506603c\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:32:18'),(391,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:32:19'),(392,NULL,'登出',0,'com.perfect.manager.controller.master.user.UserController','logout','POST','[]','http://localhost:19528/perfect-manager/api/v1/user/logout','172.21.11.100','2019-12-16 15:32:36'),(393,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:32:41'),(394,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:32:44'),(395,NULL,'根据查询条件，获取菜单主表信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:32:45'),(396,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:33:40'),(397,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:33:42'),(398,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:37:41'),(399,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:37:41'),(400,NULL,'系统菜单数据新增菜单组',68,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addMenuGroup','POST','[{\"code\":\"xx\",\"dbversion\":1,\"descr\":\"\",\"id\":20,\"name\":\"xx\",\"root_id\":20,\"u_id\":29,\"u_time\":\"2019-12-16T15:42:43.007\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addmenugroup','172.21.11.100','2019-12-16 15:42:43'),(401,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:42:47'),(402,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:43:10'),(403,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:43:10'),(404,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:43:43'),(405,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:43:48'),(406,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:43:49'),(407,NULL,'根据查询条件，获取级联信息',12,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:44:05'),(408,NULL,'根据查询条件，获取字典主表信息',109,'com.perfect.manager.controller.sys.config.dict.DictTypeController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/dicttype/list','172.21.11.100','2019-12-16 15:45:45'),(409,NULL,'根据查询条件，获取字典数据表信息',88,'com.perfect.manager.controller.sys.config.dict.DictDataController','list','POST','[{\"dictTypeCode\":\"sys_code_type\",\"dictTypeName\":\"\",\"max_sort\":0,\"min_sort\":0,\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"dictTypeCode, sort\"}}]','http://localhost:19528/perfect-manager/api/v1/dictdata/list','172.21.11.100','2019-12-16 15:45:49'),(410,NULL,'字典数据表数据新增保存',39,'com.perfect.manager.controller.sys.config.dict.DictDataController','insert','POST','[{\"c_id\":29,\"c_time\":\"2019-12-16T15:46:14.224\",\"dbversion\":0,\"descr\":\"\",\"dict_type_id\":15,\"dict_value\":\"s_menu\",\"id\":80,\"is_del\":false,\"label\":\"菜单组编号\",\"sort\":1,\"u_id\":29,\"u_time\":\"2019-12-16T15:46:14.225\"}]','http://localhost:19528/perfect-manager/api/v1/dictdata/insert','172.21.11.100','2019-12-16 15:46:14'),(411,NULL,'根据查询条件，获取系统参数信息',13,'com.perfect.manager.controller.sys.platform.syscode.PlatformCodeController','list','POST','[{\"code\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/code/list','172.21.11.100','2019-12-16 15:48:39'),(412,NULL,'系统参数数据新增保存',27,'com.perfect.manager.controller.sys.platform.syscode.PlatformCodeController','insert','POST','[{\"c_id\":29,\"c_time\":\"2019-12-16T15:48:53.564\",\"code\":\"\",\"dbversion\":0,\"id\":4,\"prefex\":\"M\",\"rule\":\"10\",\"type\":\"s_menu\",\"u_id\":29,\"u_time\":\"2019-12-16T15:48:53.564\"}]','http://localhost:19528/perfect-manager/api/v1/code/insert','172.21.11.100','2019-12-16 15:48:54'),(413,NULL,'根据查询条件，获取系统参数信息',11,'com.perfect.manager.controller.sys.platform.syscode.PlatformCodeController','list','POST','[{\"code\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/code/list','172.21.11.100','2019-12-16 15:49:22'),(414,NULL,'根据查询条件，获取级联信息',19,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:52:12'),(415,NULL,'根据查询条件，获取菜单主表信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:52:50'),(416,NULL,'系统菜单数据新增菜单组',39,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addMenuGroup','POST','[{\"code\":\"M20191216CG002\",\"dbversion\":1,\"descr\":\"\",\"id\":21,\"name\":\"测试\",\"root_id\":21,\"u_id\":29,\"u_time\":\"2019-12-16T15:52:57.031\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addmenugroup','172.21.11.100','2019-12-16 15:52:57'),(417,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:53:04'),(418,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:54:10'),(419,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:54:22'),(420,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:54:22'),(421,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:54:49'),(422,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:55:12'),(423,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:55:13'),(424,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:55:20'),(425,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:56:48'),(426,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:57:27'),(427,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:57:27'),(428,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 15:57:33'),(429,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 15:57:56'),(430,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:58:01'),(431,NULL,'根据查询条件，获取菜单主表信息',10,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:58:09'),(432,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 15:59:44'),(433,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:00:30'),(434,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:00:33'),(435,NULL,'系统菜单数据更新保存',19,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','save','POST','[{\"affix\":false,\"code\":\"M20191216CG002\",\"dbversion\":2,\"descr\":\"\",\"id\":21,\"name\":\"租户主菜单\",\"root_id\":21,\"sort\":0,\"u_id\":29,\"u_time\":\"2019-12-16T16:00:42.951\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/save','172.21.11.100','2019-12-16 16:00:43'),(436,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:00:43'),(437,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:00:45'),(438,NULL,'根据查询条件，获取资源表信息',40,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:00:47'),(439,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:01:25'),(440,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:01:32'),(441,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:01:57'),(442,NULL,'根据查询条件，获取资源表信息',19,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:02:02'),(443,NULL,'根据查询条件，获取资源表信息',26,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:02:07'),(444,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:02:12'),(445,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:02:45'),(446,NULL,'根据查询条件，获取租户信息',11,'com.perfect.manager.controller.master.org.MasterOrgController','treeList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/org/tree/list','172.21.11.100','2019-12-16 16:02:48'),(447,NULL,'根据查询条件，获取组织架构主表信息',6,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"tenant_id\":1}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 16:02:49'),(448,NULL,'根据查询条件，获取组织架构主表信息',5,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"code\":\"0001\",\"dbversion\":15,\"id\":1,\"tenant_id\":1,\"type\":\"10\",\"type_text\":\"租户\",\"u_time\":\"2019-12-02T14:24:51\"}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 16:02:49'),(449,NULL,'根据查询条件，获取组织架构主表信息',12,'com.perfect.manager.controller.master.org.MasterOrgController','list','POST','[{\"code\":\"00010004\",\"dbversion\":2,\"id\":23,\"parent_id\":1,\"tenant_id\":1,\"type\":\"20\",\"type_text\":\"集团\",\"u_time\":\"2019-12-03T11:17:12\"}]','http://localhost:19528/perfect-manager/api/v1/org/list','172.21.11.100','2019-12-16 16:02:50'),(450,NULL,'新增模式下，可新增子节点得类型',25,'com.perfect.manager.controller.master.org.MasterOrgController','getCorrectTypeByInsertStatus','POST','[{\"code\":\"00010004\",\"filter_para\":[\"60\",\"50\",\"10\"],\"tenant_id\":1,\"type\":\"20\"}]','http://localhost:19528/perfect-manager/api/v1/org/get_type','172.21.11.100','2019-12-16 16:02:51'),(451,NULL,'根据查询条件，获取集团主表信息',115,'com.perfect.manager.controller.master.org.MasterGroupController','list','POST','[{\"code\":\"\",\"is_del\":false,\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"tenant_id\":1}]','http://localhost:19528/perfect-manager/api/v1/org/group/list','172.21.11.100','2019-12-16 16:02:52'),(452,NULL,'根据查询条件，获取集团主表信息',115,'com.perfect.manager.controller.master.org.MasterGroupController','list','POST','[{\"code\":\"\",\"is_del\":false,\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"tenant_id\":1}]','http://localhost:19528/perfect-manager/api/v1/org/group/list','172.21.11.100','2019-12-16 16:02:52'),(453,NULL,'根据查询条件，获取资源表信息',19,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:03:16'),(454,NULL,'根据查询条件，获取资源表信息',18,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:03:27'),(455,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:03:33'),(456,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:03:52'),(457,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:04:34'),(458,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:04:35'),(459,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:04:37'),(460,NULL,'根据查询条件，获取资源表信息',19,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:04:38'),(461,NULL,'根据查询条件，获取资源表信息',24,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:06:06'),(462,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:06:44'),(463,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:07:56'),(464,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:07:57'),(465,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:08:01'),(466,NULL,'根据查询条件，获取资源表信息',33,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:08:02'),(467,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:08:11'),(468,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:08:28'),(469,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:08:30'),(470,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:08:31'),(471,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:08:33'),(472,NULL,'根据查询条件，获取资源表信息',26,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:08:35'),(473,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:08:53'),(474,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:14:03'),(475,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:14:04'),(476,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:14:07'),(477,NULL,'根据查询条件，获取资源表信息',27,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:14:08'),(478,NULL,'系统菜单数据新增菜单组',35,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:14:47.097\",\"code\":\"M20191216CG0020001\",\"component\":\"\",\"dbversion\":0,\"descr\":\"\",\"id\":22,\"meta_icon\":\"dashboard\",\"meta_title\":\"首页\",\"module_id\":\"1\",\"name\":\"首页\",\"parent_id\":21,\"path\":\"/dashboard\",\"root_id\":21,\"route_name\":\"P00000070\",\"son_count\":0,\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:14:47.097\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:14:47'),(479,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:14:47'),(480,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:15:35'),(481,NULL,'根据查询条件，获取菜单主表信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:15:36'),(482,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:15:52'),(483,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:15:58'),(484,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:16:42'),(485,NULL,'根据查询条件，获取菜单主表信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:16:43'),(486,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:16:44'),(487,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:17:07'),(488,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:18:16'),(489,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:18:18'),(490,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:18:19'),(491,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:18:45'),(492,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:18:48'),(493,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:18:49'),(494,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:18:51'),(495,NULL,'根据查询条件，获取级联信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:20:06'),(496,NULL,'根据查询条件，获取资源表信息',20,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:20:15'),(497,NULL,'根据查询条件，获取资源表信息',27,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:20:23'),(498,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:21:02'),(499,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:21:04'),(500,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:21:07'),(501,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:21:15'),(502,NULL,'根据查询条件，获取资源表信息',24,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:21:19'),(503,NULL,'根据查询条件，获取菜单主表信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:22:01'),(504,NULL,'根据查询条件，获取级联信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:22:32'),(505,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:22:36'),(506,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:22:40'),(507,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:24:29'),(508,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:25:17'),(509,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:25:17'),(510,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:25:41'),(511,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:26:25'),(512,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:26:31'),(513,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:26:34'),(514,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:27:00'),(515,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:27:02'),(516,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:27:10'),(517,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:27:41'),(518,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:27:54'),(519,NULL,'根据查询条件，获取级联信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:28:09'),(520,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:28:38'),(521,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:28:39'),(522,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:29:08'),(523,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:29:12'),(524,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:29:26'),(525,NULL,'根据查询条件，获取级联信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:29:31'),(526,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:29:57'),(527,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:30:36'),(528,NULL,'根据查询条件，获取级联信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:31:24'),(529,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:31:42'),(530,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:31:53'),(531,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:32:55'),(532,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:33:28'),(533,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:33:45'),(534,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:34:06'),(535,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:34:20'),(536,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:34:29'),(537,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:34:30'),(538,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:34:33'),(539,NULL,'根据查询条件，获取资源表信息',20,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:34:34'),(540,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:35:39'),(541,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:35:42'),(542,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:35:47'),(543,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:35:48'),(544,NULL,'根据查询条件，获取级联信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:35:54'),(545,NULL,'系统菜单数据更新保存',16,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','save','POST','[{\"affix\":false,\"code\":\"M20191216CG0020001\",\"component\":\"\",\"dbversion\":1,\"descr\":\"\",\"id\":22,\"meta_icon\":\"dashboard\",\"meta_title\":\"首页\",\"name\":\"首页\",\"parent_id\":22,\"path\":\"/dashboard\",\"root_id\":21,\"route_name\":\"P00000070\",\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:36:02.665\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/save','172.21.11.100','2019-12-16 16:36:03'),(546,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:36:10'),(547,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:36:11'),(548,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:36:31'),(549,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:36:34'),(550,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:36:59'),(551,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:37:41'),(552,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:37:42'),(553,NULL,'根据查询条件，获取菜单主表信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:37:52'),(554,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:37:55'),(555,NULL,'根据查询条件，获取资源表信息',18,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:37:58'),(556,NULL,'系统菜单数据新增菜单组',48,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:38:01.448\",\"code\":\"M20191216CG0020002\",\"component\":\"/views/10_master/group/group\",\"dbversion\":0,\"descr\":\"\",\"id\":23,\"meta_icon\":\"集团信息\",\"meta_title\":\"集团信息\",\"module_id\":\"11\",\"name\":\"集团信息\",\"parent_id\":21,\"path\":\"group\",\"root_id\":21,\"route_name\":\"P00000100\",\"son_count\":0,\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:38:01.448\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:38:01'),(557,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:38:02'),(558,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:38:04'),(559,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:38:48'),(560,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:38:48'),(561,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:38:51'),(562,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:39:20'),(563,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:41:35'),(564,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:41:38'),(565,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:41:41'),(566,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:41:42'),(567,NULL,'根据查询条件，获取级联信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:41:46'),(568,NULL,'获取用户信息',0,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:42:08'),(569,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:42:09'),(570,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:42:11'),(571,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:42:28'),(572,NULL,'根据查询条件，获取级联信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:42:31'),(573,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:42:33'),(574,NULL,'系统菜单数据新增菜单组',24,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:42:38.637\",\"code\":\"M20191216CG0020003\",\"component\":\"\",\"dbversion\":0,\"descr\":\"\",\"id\":24,\"meta_icon\":\"dashboard\",\"meta_title\":\"首页\",\"module_id\":\"1\",\"name\":\"首页\",\"parent_id\":21,\"path\":\"/dashboard\",\"root_id\":21,\"route_name\":\"P00000070\",\"son_count\":0,\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:42:38.637\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:42:39'),(575,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:42:39'),(576,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:42:46'),(577,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:42:48'),(578,NULL,'系统菜单数据新增菜单组',25,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:42:56.203\",\"code\":\"M20191216CG0020004\",\"component\":\"/views/01_dashboard/index\",\"dbversion\":0,\"descr\":\"\",\"id\":25,\"meta_icon\":\"系统管理\",\"meta_title\":\"系统管理\",\"module_id\":\"2\",\"name\":\"系统管理\",\"parent_id\":21,\"path\":\"/sys\",\"root_id\":21,\"route_name\":\"M00000010\",\"son_count\":0,\"sort\":0,\"type\":\"c\",\"u_id\":29,\"u_time\":\"2019-12-16T16:42:56.203\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:42:56'),(579,NULL,'根据查询条件，获取菜单主表信息',4,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:42:57'),(580,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:43:05'),(581,NULL,'系统菜单数据新增菜单组',29,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addMenuGroup','POST','[{\"code\":\"M20191216AW003\",\"dbversion\":1,\"descr\":\"\",\"id\":26,\"name\":\"系统管理员\",\"root_id\":26,\"u_id\":29,\"u_time\":\"2019-12-16T16:44:35.273\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addmenugroup','172.21.11.100','2019-12-16 16:44:35'),(582,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:44:45'),(583,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:44:48'),(584,NULL,'系统菜单数据新增菜单组',26,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addMenuGroup','POST','[{\"code\":\"M20191216DR004\",\"dbversion\":1,\"descr\":\"\",\"id\":27,\"name\":\"xxx\",\"root_id\":27,\"u_id\":29,\"u_time\":\"2019-12-16T16:44:55.245\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addmenugroup','172.21.11.100','2019-12-16 16:44:55'),(585,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:44:59'),(586,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:45:02'),(587,NULL,'根据查询条件，获取级联信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:45:04'),(588,NULL,'系统菜单数据新增菜单组',29,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addMenuGroup','POST','[{\"code\":\"M20191216RE005\",\"dbversion\":1,\"descr\":\"\",\"id\":28,\"name\":\"xxx\",\"root_id\":28,\"u_id\":29,\"u_time\":\"2019-12-16T16:45:14.208\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addmenugroup','172.21.11.100','2019-12-16 16:45:14'),(589,NULL,'系统菜单数据新增菜单组',30,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addMenuGroup','POST','[{\"code\":\"M20191216QR006\",\"dbversion\":1,\"descr\":\"\",\"id\":29,\"name\":\"xxx\",\"root_id\":29,\"u_id\":29,\"u_time\":\"2019-12-16T16:45:19.583\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addmenugroup','172.21.11.100','2019-12-16 16:45:20'),(590,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:45:24'),(591,NULL,'根据查询条件，获取菜单主表信息',11,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:45:26'),(592,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:45:28'),(593,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:45:31'),(594,NULL,'根据查询条件，获取菜单主表信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:45:49'),(595,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:47:12'),(596,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:47:28'),(597,NULL,'系统菜单数据新增菜单组',28,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addMenuGroup','POST','[{\"code\":\"M20191216KZ007\",\"dbversion\":1,\"descr\":\"\",\"id\":30,\"name\":\"系统管理员\",\"root_id\":30,\"u_id\":29,\"u_time\":\"2019-12-16T16:47:43.359\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addmenugroup','172.21.11.100','2019-12-16 16:47:43'),(598,NULL,'根据查询条件，获取级联信息',5,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:47:46'),(599,NULL,'根据查询条件，获取资源表信息',19,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:47:48'),(600,NULL,'系统菜单数据新增菜单组',28,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:52:16.836\",\"code\":\"M20191216KZ0070001\",\"component\":\"\",\"dbversion\":0,\"descr\":\"\",\"id\":32,\"meta_icon\":\"dashboard\",\"meta_title\":\"首页\",\"module_id\":\"1\",\"name\":\"首页\",\"parent_id\":30,\"path\":\"/dashboard\",\"root_id\":30,\"route_name\":\"P00000070\",\"son_count\":0,\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:52:16.836\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:52:17'),(601,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:52:17'),(602,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:52:27'),(603,NULL,'根据查询条件，获取资源表信息',24,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:52:29'),(604,NULL,'系统菜单数据新增菜单组',36,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:52:43.077\",\"code\":\"M20191216KZ0070002\",\"component\":\"/views/01_dashboard/index\",\"dbversion\":0,\"descr\":\"\",\"id\":33,\"meta_icon\":\"系统管理\",\"meta_title\":\"系统管理\",\"module_id\":\"2\",\"name\":\"系统管理\",\"parent_id\":30,\"path\":\"/sys\",\"root_id\":30,\"route_name\":\"M00000010\",\"son_count\":0,\"sort\":0,\"type\":\"c\",\"u_id\":29,\"u_time\":\"2019-12-16T16:52:43.077\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:52:43'),(605,NULL,'根据查询条件，获取菜单主表信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:52:43'),(606,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:52:46'),(607,NULL,'根据查询条件，获取资源表信息',19,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:52:50'),(608,NULL,'系统菜单数据新增菜单组',23,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:53:51.206\",\"code\":\"M20191216KZ00700020001\",\"dbversion\":0,\"descr\":\"\",\"id\":34,\"meta_icon\":\"字典管理\",\"meta_title\":\"字典管理\",\"module_id\":\"5\",\"name\":\"字典管理\",\"parent_id\":33,\"path\":\"dic\",\"root_id\":30,\"route_name\":\"M00000020\",\"son_count\":0,\"sort\":0,\"type\":\"c\",\"u_id\":29,\"u_time\":\"2019-12-16T16:53:51.206\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:53:51'),(609,NULL,'根据查询条件，获取菜单主表信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:53:51'),(610,NULL,'根据查询条件，获取级联信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:54:04'),(611,NULL,'根据查询条件，获取资源表信息',19,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:54:05'),(612,NULL,'系统菜单数据新增菜单组',29,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:54:14\",\"code\":\"M20191216KZ007000200010001\",\"component\":\"/views/00_system/dicttype/dicttype\",\"dbversion\":0,\"descr\":\"\",\"id\":35,\"meta_icon\":\"字典类型\",\"meta_title\":\"字典类型\",\"module_id\":\"6\",\"name\":\"字典类型\",\"parent_id\":34,\"path\":\"dicttype\",\"root_id\":30,\"route_name\":\"P00000030\",\"son_count\":0,\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:54:14\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:54:14'),(613,NULL,'根据查询条件，获取菜单主表信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:54:14'),(614,NULL,'根据查询条件，获取级联信息',6,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:54:17'),(615,NULL,'根据查询条件，获取资源表信息',22,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:54:18'),(616,NULL,'系统菜单数据新增菜单组',25,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:54:22.787\",\"code\":\"M20191216KZ007000200010002\",\"component\":\"/views/00_system/dictdata/dictdata\",\"dbversion\":0,\"descr\":\"\",\"id\":36,\"meta_icon\":\"字典数据\",\"meta_title\":\"字典数据\",\"module_id\":\"7\",\"name\":\"字典数据\",\"parent_id\":34,\"path\":\"dictdata\",\"root_id\":30,\"route_name\":\"P00000050\",\"son_count\":0,\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:54:22.787\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:54:23'),(617,NULL,'根据查询条件，获取菜单主表信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:54:23'),(618,NULL,'根据查询条件，获取级联信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:54:37'),(619,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:54:38'),(620,NULL,'系统菜单数据新增菜单组',25,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','addSubMenu','POST','[{\"affix\":false,\"c_id\":29,\"c_time\":\"2019-12-16T16:54:57.849\",\"code\":\"M20191216KZ00700020002\",\"component\":\"/views/00_system/resource/resource\",\"dbversion\":0,\"descr\":\"\",\"id\":37,\"meta_icon\":\"资源管理\",\"meta_title\":\"资源管理\",\"module_id\":\"3\",\"name\":\"资源管理\",\"parent_id\":33,\"path\":\"resource\",\"root_id\":30,\"route_name\":\"P00000020\",\"son_count\":0,\"sort\":0,\"type\":\"m\",\"u_id\":29,\"u_time\":\"2019-12-16T16:54:57.849\",\"visible\":false}]','http://localhost:19528/perfect-manager/api/v1/menu/addsubmenu','172.21.11.100','2019-12-16 16:54:58'),(621,NULL,'根据查询条件，获取菜单主表信息',8,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:54:58'),(622,NULL,'根据查询条件，获取菜单主表信息',19,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','list','POST','[{\"code\":\"\",\"leaf\":true,\"level\":0,\"name\":\"\",\"sort\":0}]','http://localhost:19528/perfect-manager/api/v1/menu/list','172.21.11.100','2019-12-16 16:55:05'),(623,NULL,'根据查询条件，获取级联信息',7,'com.perfect.manager.controller.sys.rabc.menu.SysMenuController','cascaderList','POST','[null]','http://localhost:19528/perfect-manager/api/v1/menu/cascader/list','172.21.11.100','2019-12-16 16:55:12'),(624,NULL,'根据查询条件，获取资源表信息',25,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:55:13'),(625,NULL,'根据查询条件，获取资源表信息',17,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"模块\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:55:18'),(626,NULL,'根据查询条件，获取资源表信息',20,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:55:30'),(627,NULL,'获取用户信息',1,'com.perfect.manager.controller.master.user.UserController','userInfo','GET','[\"8fbc38e3-c098-4ef2-a8d1-9f3be055fc4e\"]','http://localhost:19528/perfect-manager/api/v1/user/info','172.21.11.100','2019-12-16 16:57:19'),(628,NULL,'根据查询条件，获取资源表信息',21,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 16:57:19'),(629,NULL,'根据查询条件，获取字典主表信息',9,'com.perfect.manager.controller.sys.config.dict.DictTypeController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/dicttype/list','172.21.11.100','2019-12-16 16:57:23'),(630,NULL,'根据查询条件，获取字典数据表信息',16,'com.perfect.manager.controller.sys.config.dict.DictDataController','list','POST','[{\"dictTypeCode\":\"sys_module_type\",\"dictTypeName\":\"\",\"max_sort\":0,\"min_sort\":0,\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"dictTypeCode, sort\"}}]','http://localhost:19528/perfect-manager/api/v1/dictdata/list','172.21.11.100','2019-12-16 16:57:33'),(631,NULL,'根据查询条件，获取系统参数信息',14,'com.perfect.manager.controller.sys.platform.syscode.PlatformCodeController','list','POST','[{\"code\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"}}]','http://localhost:19528/perfect-manager/api/v1/code/list','172.21.11.100','2019-12-16 16:57:39'),(632,NULL,'根据查询条件，获取资源表信息',20,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 17:00:14'),(633,NULL,'根据查询条件，获取资源表信息',69,'com.perfect.manager.controller.sys.config.module.ModuleController','list','POST','[{\"code\":\"\",\"name\":\"\",\"pageCondition\":{\"current\":1,\"size\":20,\"sort\":\"-u_time\"},\"types\":[]}]','http://localhost:19528/perfect-manager/api/v1/module/list','172.21.11.100','2019-12-16 17:00:21');
...
CREATE TABLE `s_log_mq` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=186 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='消息队列日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log_oper` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '操作日志记录',
  `title` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '模块标题',
  `business_type` int(11) DEFAULT NULL COMMENT '业务类型（0其它 1新增 2修改 3删除）',
  `method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '方法名称',
  `operator_type` int(11) DEFAULT NULL COMMENT '操作类别（0其它 1后台用户 2手机端用户）',
  `oper_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作人员',
  `dept_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '部门名称',
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '请求URL',
  ...
  `param` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作状态（0正常 1异常）',
  `status` tinyint(1) DEFAULT NULL COMMENT '操作状态（0正常 1异常）',
  `error_msg` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_module` VALUES (1,'Dashboard','m','首页',NULL,'/dashboard','P00000070','首页','dashboard','',1,NULL,'',0,1,'2019-10-31 16:04:03',1,'2019-11-01 09:37:57',1),(2,'sys','c','系统管理',NULL,'/sys','M00000010','系统管理','系统管理','/views/01_dashboard/index',0,NULL,'',0,1,'2019-11-01 09:51:10',1,'2019-11-01 10:02:30',4),(3,'resource','m','资源管理',NULL,'resource','P00000020','资源管理','资源管理','/views/00_system/resource/resource',0,NULL,'',0,1,'2019-11-01 10:05:27',1,'2019-11-01 10:05:27',0),(4,'module','m','模块编辑',NULL,'module','P00000040','模块编辑','模块编辑','/views/00_system/module/module',0,NULL,'',0,1,'2019-11-01 10:06:05',1,'2019-11-01 10:06:05',0),(5,'dic','c','字典管理',NULL,'dic','M00000020','字典管理','字典管理',NULL,0,NULL,'',0,1,'2019-11-01 10:26:50',1,'2019-11-01 10:26:50',0),(6,'dicttype','m','字典类型',NULL,'dicttype','P00000030','字典类型','字典类型','/views/00_system/dicttype/dicttype',0,NULL,'',0,1,'2019-11-01 10:27:38',1,'2019-11-01 10:27:38',0),(7,'dictdata','m','字典数据',NULL,'dictdata','P00000050','字典数据','字典数据','/views/00_system/dictdata/dictdata',0,NULL,'',0,1,'2019-11-01 10:28:12',1,'2019-11-01 10:28:12',0),(8,'config','m','系统参数',NULL,'config','P00000060','系统参数','系统参数','/views/00_system/config/config',0,NULL,'',0,1,'2019-11-01 10:28:53',1,'2019-11-01 10:28:53',0),(9,'tenant','m','租户管理',NULL,'tenant','P00000080','租户管理','tenant','/views/00_system/tenant/tenant',0,NULL,'',0,1,'2019-11-01 10:29:23',1,'2019-11-01 10:29:23',0),(10,'org','c','组织架构',NULL,'org','M00000030','组织架构','组织架构',NULL,0,NULL,'',0,1,'2019-11-01 10:30:04',1,'2019-11-01 10:30:04',0),(11,'group','m','集团信息',NULL,'group','P00000100','集团信息','集团信息','/views/10_master/group/group',0,NULL,'',0,1,'2019-11-01 10:30:44',1,'2019-11-01 10:31:07',1),(12,'company','m','企业信息',NULL,'company','P00000110','企业信息','企业信息','/views/10_master/company/company',0,NULL,'',0,1,'2019-11-01 10:31:36',1,'2019-11-04 09:28:58',2);
...
CREATE TABLE `s_module_button` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='模块按钮信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_sms_code` (
  ...
  `code` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '验证码',
  `type` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '0:未知/1:注册/2:忘记密码/3:修改绑定手机',
  `c_id` bigint(20) DEFAULT NULL,
  `c_time` datetime DEFAULT NULL,
  `u_id` bigint(20) DEFAULT NULL,
  `u_time` datetime DEFAULT NULL,
...
INSERT INTO `s_tenant` VALUES (1,NULL,'0001','1','中建',NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,'2019-10-09 01:22:29',1,'2019-10-09 01:22:29',0),(13,NULL,'0001','ZH20191216NX001','测试','测试',0,'2019-12-16 14:23:30','2020-01-16 14:23:30',0,NULL,NULL,NULL,NULL,0,NULL,'2019-12-16 14:23:37',NULL,'2019-12-16 14:23:37',0);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_dict_info` AS select `t1`.`name` AS `name`,`t2`.`label` AS `label`,`t1`.`code` AS `code`,`t2`.`dict_value` AS `dict_value`,`t1`.`is_del` AS `is_del` from (`s_dict_type` `t1` join `s_dict_data` `t2` on((`t1`.`id` = `t2`.`dict_type_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-12-16 17:02:30
