...
CREATE TABLE `m_staff` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='员工信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `m_staff` VALUES (22,'负责人',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,24,0,1,1,'2019-11-12 11:19:48',1,'2019-11-12 11:19:48',1),(23,'副负责人',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,25,0,1,1,'2019-11-12 11:21:20',1,'2019-11-12 11:21:20',1),(24,'领导',NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,26,0,1,1,'2019-11-12 11:22:34',1,'2019-11-12 11:22:34',1),(25,'测试登录',NULL,NULL,NULL,'1',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','啊',NULL,29,0,1,1,'2019-11-12 11:22:34',29,'2019-11-19 11:27:52',4),(26,'领导1想',NULL,NULL,NULL,'1',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,26,0,1,29,'2019-11-12 11:22:34',29,'2019-11-19 11:43:42',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='编码控制';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_code` VALUES (2,'s_tenant','10','ZH20191213YK005',5,'ZH',29,'2019-12-13 15:11:44',29,'2019-12-13 15:33:12',4),(3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0);
...
CREATE TABLE `s_dict_data` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log` (
  ...
  `c_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=230 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_log_mq` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='消息队列日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_menu` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `idx_route_name_1` (`route_name`) USING BTREE,
  UNIQUE KEY `idx_route_name_2` (`code`,`tenant_id`) USING BTREE,
  UNIQUE KEY `idx_route_name_3` (`root_id`,`route_name`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_menu` VALUES (14,'ce','测试',14,NULL,2,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,1,'2019-11-05 10:46:34',1,'2019-11-05 10:47:13',3),(15,'ce0001','系统管理',14,14,1,0,'c',0,NULL,2,'/sys','M00000010','系统管理','系统管理','/views/01_dashboard/index',0,'',NULL,1,'2019-11-05 10:46:51',1,'2019-11-05 10:47:24',1),(16,'ce0002','字典管理',14,14,2,0,'c',0,NULL,5,'dic','M00000020','字典管理','字典管理',NULL,0,'',NULL,1,'2019-11-05 10:47:13',1,'2019-11-05 10:47:44',2),(17,'ce00010001','租户管理',14,15,0,0,'m',0,NULL,9,'tenant','P00000080','租户管理','tenant','/views/00_system/tenant/tenant',0,'',NULL,1,'2019-11-05 10:47:24',1,'2019-11-05 10:47:24',0),(18,'ce00020001','字典类型',14,16,0,0,'m',0,NULL,6,'dicttype','P00000030','字典类型','字典类型','/views/00_system/dicttype/dicttype',0,'',NULL,1,'2019-11-05 10:47:35',1,'2019-11-05 10:47:35',0),(19,'ce00020002','字典数据',14,16,0,0,'m',0,NULL,7,'dictdata','P00000050','字典数据','字典数据','/views/00_system/dictdata/dictdata',0,'',NULL,1,'2019-11-05 10:47:44',1,'2019-11-05 10:47:44',0);
...
CREATE TABLE `s_sms_code` (
  ...
  `u_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='短信验证码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `s_tenant` (
  ...
  `dbversion` int(11) DEFAULT '0' COMMENT '数据版本，乐观锁使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='租户主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_tenant` VALUES (1,NULL,'0001','1','中建',NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,'2019-10-09 01:22:29',1,'2019-10-09 01:22:29',0);
...
-- Dump completed on 2019-12-13 17:15:03
