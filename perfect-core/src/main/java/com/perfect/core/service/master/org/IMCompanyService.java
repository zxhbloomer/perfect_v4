...
public interface IMCompanyService extends IService<MCompanyEntity> {
     ...
     * 获取列表，页面查询
     */
    IPage<MCompanyEntity> selectPage(MCompanyVo searchCondition) throws InstantiationException, IllegalAccessException;

    /**
     * 获取所有数据
     */
    List<MCompanyEntity> select(MCompanyVo searchCondition) throws InstantiationException, IllegalAccessException;

    /**
     * 获取所选id的数据
     */
    List<MCompanyEntity> selectIdsIn(List<MCompanyVo> searchCondition) throws InstantiationException, IllegalAccessException;
