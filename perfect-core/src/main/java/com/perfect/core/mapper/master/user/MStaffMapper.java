...
public interface MStaffMapper extends BaseMapper<MStaffEntity> {
    ...
    String common_select = "       "
        ...
        + "                         SELECT                                                                                      "
        + "                                sub_tab1.staff_id,                                                                   "
        + "                                JSON_ARRAYAGG(JSON_OBJECT('position_id',sub_tab2.id,                                 "
        + "                                                          'position_name',sub_tab2.name,                             "
        + "                                                          'position_simple_name',sub_tab2.simple_name)               "
        + "                                              ) as positions                                                         "
        + "                           FROM                                                                                      "
        + "                                m_staff_org sub_tab1                                                                 "
        + "                     INNER JOIN m_position sub_tab2 ON sub_tab1.serial_type = '" + PerfectDictConstant.DICT_SYS_CODE_TYPE_M_POSITION + "' AND sub_tab1.serial_id = sub_tab2.id       "
        + "                       group by sub_tab1.staff_id                                                                    "
