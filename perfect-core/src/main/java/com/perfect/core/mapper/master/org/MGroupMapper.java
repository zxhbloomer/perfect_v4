...
public interface MGroupMapper extends BaseMapper<MGroupEntity> {
    ...
    @Select("    "
        ...
        + "  LEFT JOIN v_org_route_json org_route ON t.id = org_route.serial_id                                      "
        + "        and org_route.serial_type = '" + PerfectDictConstant.DICT_ORG_SETTING_TYPE_GROUP_SERIAL_TYPE + "' "
        + "        and t.tenant_id = org_route.tenant_id                                                             "
        + "  where true                                                                                              "
